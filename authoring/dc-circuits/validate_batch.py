...
master_path=Path(sys.argv[1]); batch_path=Path(sys.argv[2]) if len(sys.argv)>2 else Path(__file__).with_name('dc-circuits-batch-01.json')
...
for n in b['nodes']:
 ...
 assert n['proficiency80'] is None and n['domain']=='Electronics'
